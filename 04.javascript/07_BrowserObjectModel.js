...
btn1.addEventListener('click', ()=>{
    ...
    // window.open('https://www.google.com', 'naver');

    // 특성의 경우 브라우저마다 다르게 동작하기 때문에 정상적으로 동작하는지는 꼭 확인해야 한다. 
    window.open('https://www.naver.com', 'naver', 'width=500', 'height=600', 'resizable');
});
...
btn2.addEventListener('click', ()=>{
    ...
    // newWindow.opener.close(); // 이 윈도우를 오픈해주었던 앞 페이지를 닫아준다.
