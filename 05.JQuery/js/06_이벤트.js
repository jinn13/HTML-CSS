$(()=>{
    ...
    // 1) on()와 off()
    // $('#area1').on('mouseenter', ()=>{
    //     $('#area1').css('background', 'orange').text('마우스가 올라감');
    // });
    ...
    //     $(event.target).css('background', 'white').text('')
    //     // .off('mouseenter').off('mouseleave'); 이렇게도 가능
    ...
    //     // console.log(`맥스 : ${maxLength}`);
        
    //     if((maxLength-inputLength) < 0){
    //         counter.css('color', 'red');
    //         // inputValue.substr(inputValue.substr(0, maxLength));
    //     }else{
